const SearchModule = {
    ...
    renderFilters(filters, counts) {
        ...
        this.filtersList.style.display = 'block'; // Forzar visibilidad cuando hay filtros
                        ...
                        <table>
                            ...
                            <tbody>
                                ${data.results.map(email => {
                                    ...
                                    const displayText = isIndex ? UtilsModule.truncateIndex(identifier) : (identifier.slice(1, 11) + '...');
