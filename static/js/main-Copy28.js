/* Artifact ID: b8d940ed-82df-43f5-86c1-ddefd3568867 */
/* Version: e9c7b6f4-9a3d-4e7b-c6f8-4b3e2a5d0f1c */
document.addEventListener('DOMContentLoaded', () => {
    ...
    processDeepAnalysisBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            deepAnalysisResponse.innerHTML = '<p>Análisis inicializado para los temas seleccionados. Ingresa tu consulta.</p>';
        } catch (error) {
    ...
    submitDeepAnalysisBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            deepAnalysisResponse.innerHTML = `
                ...
                <h3>Referencias:</h3>
                <ul>${data.references.map(ref => `<li>Correo ${escapeHtml(ref)}</li>`).join('') || '<li>Ninguna</li>'}</ul>
            `;
