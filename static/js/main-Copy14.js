document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderFilters(filters, counts = { remove: {}, add: {} }) {
        ...
        filters.forEach((filter, index) => {
            ...
            const countText = filter.action === 'remove' ? `(${count} correos eliminados)` : `(${count} correos añadidos)`;
            li.innerText = `${actionText}: ${termsText} ${countText}`;
                ...
                link.addEventListener('click', async (e) => {
                    ...
                    try {
                        ...
                        modalContent.innerHTML = `
                            ...
                            <strong>Resumen:</strong> ${escapeHtml(email.summary || 'N/A')}</p>
