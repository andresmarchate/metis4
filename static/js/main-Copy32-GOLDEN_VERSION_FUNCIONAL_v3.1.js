...
/* Version: b6c7d8e9-f0g1-h2i3-j4k5-l6m7n8o9p0 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!conversationsSection || !conversationsForm || !errorMessageConversations || !conversationsCount || !conversationsThemes) {
    ...
    function escapeHtml(unsafe, isMessageId = false) {
        ...
        // Preserve email formats like "Name <email>", "<email>", or plain email
    ...
    submitDeepAnalysisBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            // Process reasoning to make indices clickable
