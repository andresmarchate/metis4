document.addEventListener('DOMContentLoaded', () => {
    ...
    // Format email address with name (e.g., "Name <email@domain.com>")
    function formatEmail(field) {
        ...
        // If field contains an email address (has @), wrap it in angle brackets
        if (field.includes('@')) {
            return `<${field}>`;
        }
        // Otherwise, return the field as-is (likely a name without email)
        return field;
    }
                ...
                link.addEventListener('click', async (e) => {
                    ...
                    try {
                        ...
                        modalContent.innerHTML = `
                            <p><strong>ID:</strong> ${email.message_id || 'N/A'}</p>
                            ...
                            <p><strong>Resumen:</strong> ${email.summary || 'N/A'}</p>
                            <p><strong>Cuerpo:</strong> ${email.body || 'N/A'}</p>
                            <p><strong>Adjuntos:</strong> ${email.attachments_content || 'N/A'}</p>
                        `;
