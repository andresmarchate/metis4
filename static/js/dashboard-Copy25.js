const DashboardModule = {
                ...
                ${todos.map(todo => {
                    ...
                    return `
                        <div class="todo-item ${colorClass}">
                            ...
                            <span class="todo-subject" onclick="DashboardModule.showThreadEmailsModal('${todo._id}')"><strong>Asunto:</strong> ${todo.subject || 'Sin Asunto'}</span>
    ...
    async fetchEmailList(metricKey, period, sender = null, recipient = null) {
        ...
        try {
            if (!period) {
                console.error('Period is undefined for metric:', metricKey);
                return { emails: [], requestId };
            }
