                    ...
                    <table>
                        ...
                        <tbody>
                            ${theme.emails?.map(email => {
                                ...
                                return `
                                    <tr>
                                        <td><a href="#" class="theme-email-link" data-index="${escapeHtml(index)}">${escapeHtml(index)}</a></td>
    ...
    async function performSearch() {
        ...
        try {
            ...
            results.forEach(result => {
                ...
                const index = result.index && result.index !== 'N/A' && result.index ? result.index : result.message_id;
                const row = document.createElement('tr');
                row.innerHTML = `
                    <td><a href="#" class="index-link" data-index="${escapeHtml(index)}">${escapeHtml(index)}</a></td>
