...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!conversationsSection || !conversationsForm || !senderInput || !recipientInput || !errorMessageConversations || !conversationsCount || !conversationsThemes) {
    ...
    resetDeepAnalysisContextBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            alert('Contexto reseteado exitosamente.');
        } catch (error) {
    ...
    conversationsForm.addEventListener('submit', (e) => {
        e.preventDefault();
        console.log('Conversations form submitted');
        errorMessageConversations.textContent = 'Funcionalidad en desarrollo.';
        errorMessageConversations.style.display = 'block';
    });
