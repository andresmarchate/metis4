...
/* Version: r7s8t9u0-v1w2-x3y4-z5a6-b7c8d9e0f1 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!conversationsSection || !conversationsForm || !senderInput || !recipientInput || !startDateInput || !endDateInput || !errorMessageConversations || !conversationsCount || !conversationsTable || !conversationsBody || !conversationsThemes) {
    ...
    async function performSearch() {
        ...
        try {
            ...
            resultsCount.textContent = `Se found ${totalResults} correos relevantes`;
    ...
    // Initialize autocomplete for sender and recipient fields
    ...
    initializeAutocomplete(senderInput);
    initializeAutocomplete(recipientInput);
    ...
    async function performConversationSearch() {
        ...
        console.log('Performing conversation search:', { sender, recipient, startDate, endDate });

        if (!sender || !recipient || !startDate || !endDate) {
        ...
        try {
            console.log('Sending POST request to /api/conversation_emails', { sender, recipient, startDate, endDate });
