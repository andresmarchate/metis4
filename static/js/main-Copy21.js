                    ...
                    <table>
                        ...
                        <tbody>
                            ${theme.emails?.map(email => {
                                ...
                                const index = email.index && email.index !== 'N/A' ? email.index : null;
                                return `
                                    <tr>
                                        <td>${index ? `<a href="#" class="theme-email-link" data-index="${escapeHtml(index)}">${escapeHtml(index)}</a>` : escapeHtml(email.message_id || 'N/A')}</td>
    ...
    async function performSearch() {
        ...
        try {
            ...
            results.forEach(result => {
                ...
                const index = result.index && result.index !== 'N/A' ? result.index : null;
                const row = document.createElement('tr');
                row.innerHTML = `
                    <td>${index ? `<a href="#" class="index-link" data-index="${escapeHtml(index)}">${escapeHtml(index)}</a>` : escapeHtml(result.message_id || 'N/A')}</td>
