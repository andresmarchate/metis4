...
def process_query(query, return_names=False):
    ...
    - "intent": La intención principal de la consulta. Ejemplos: "ofertas_viaje", "inversiones", "medicina_y_salud", "informacion_juridica", "general". Para consultas sobre términos legales como "juzgado", "procedimiento" o "abierto", la intención debe ser "informacion_juridica".
    ...
    **Instrucciones**:
    1. Identifica la intención principal basándote en el propósito de la consulta. Si se mencionan términos legales como "juzgado", "procedimiento" o "abierto", la intención debe ser "informacion_juridica".
    ...
    **Ejemplos**:
    ...
    - Consulta: "busco tratamientos para el dolor en madrid"
      Respuesta: {{"intent": "medicina_y_salud", "terms": ["tratamiento", "dolor", "madrid"], "conditions": {{}}, "metadata_filters": {{}}, "names": []}}
