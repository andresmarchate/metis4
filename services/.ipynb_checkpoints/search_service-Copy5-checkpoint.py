...
def search_emails(processed_query, intent, terms, query_embedding, min_relevance=25, page=1, results_per_page=25):
    ...
    try:
        ...
        if intent == 'ofertas_viaje':
            ...
            conditions['semantic_domain'] = stripping
        ...
        ranked_results = []
        relevance_scores = []  # To track distribution of scores
        semantic_scores = []  # To normalize semantic scores
        text_scores = []  # To normalize text scores
        ...
        # Normalize scores
        max_semantic_score = max(semantic_scores, default=1) or 1  # Avoid division by zero
        min_semantic_score = min(semantic_scores, default=0)
        max_text_score = max(text_scores, default=1) or 1  # Avoid division by zero
        ...
        for idx, email in enumerate(results, start=1):
            ...
            # Adjusted weights and scaling to spread scores
        ...
        # Log relevance score distribution and filtering stats
        if relevance_scores:
