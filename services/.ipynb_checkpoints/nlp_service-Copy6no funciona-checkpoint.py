...
def process_query(query, return_names=False):
    ...
    **Instrucciones**:
    1. Identifica la intención: "ofertas_viaje" para viajes/reservas, "informacion_juridica" para temas legales (juzgados, abogados), "negociaciones_inmobiliarias" para bienes raíces (compra, venta, condominio).
    ...
    # Post-procesamiento para intención
    ...
    elif any(word in query for word in ["vivienda", "condominio", "extincion", "compra", "venta", "hipoteca"]):
