...
def extract_scores(explanation, text_details=[], domain_score=0.0, semantic_score=0.0):
    ...
    if 'value' in explanation and explanation['value'] > 0:
        ...
        if 'weight' in desc:
            # Extraer el campo y el término si es una coincidencia de texto
            ...
            for detail in explanation.get('details', []):
                t_details, d_score, s_score = extract_scores(detail)
