...
def analyze_themes(email_ids, user):
    ...
    try:
        ...
        for email in emails:
            ...
            body_excerpt = email.get('body', '')[:100]  # Include first 100 chars of body
        ...
        min_clusters = 2
        max_clusters = min(max(2, int(n_emails / 10)), 50)  # Dynamic max clusters
        ...
        similarity_threshold = np.percentile(similarities, 25)  # Use 25th percentile
