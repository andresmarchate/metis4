# Artifact ID: 413936ab-9752-4d79-aece-d10b5eabf191
# Version: d3f5a8c7-6b4e-4f9a-c2d7-1a3e9b8f2c6d
import logging
...
def analyze_themes(email_ids):
    ...
    logger.info(f"Analyzing themes for {len(email_ids)} emails with IDs: {email_ids[:5]}...")
    try:
        ...
        if not emails:
            logger.warning("No emails found for provided indices")
            return []
