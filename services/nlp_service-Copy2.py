...
def normalize_text(text):
    ...
    try:
        ...
        # Eliminar caracteres especiales, conservar solo alfanuméricos y espacios
...
def process_query(query):
    ...
    **Instrucciones**:
    ...
    # Post-process intent for better accuracy
    query_lower = query.lower()
    if "etoro" in query_lower or "inversion" in query_lower or "trading" in query_lower or "acciones" in query_lower:
        intent = "inversiones"
    elif "vuelo" in query_lower or "viaje" in query_lower or "hotel" in query_lower or "oferta" in query_lower:
        intent = "ofertas_viaje"
    elif "medicina" in query_lower or "medico" in query_lower or "salud" in query_lower or "farmacia" in query_lower:
        intent = "medicina_y_salud"

    # Remove generic terms like "correos" from terms to avoid overly broad matches
    ...
    return {"intent": intent, "terms": terms, "conditions": conditions}, intent, terms, embedding