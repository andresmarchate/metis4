...
def search_emails(processed_query, intent, term_groups, query_embedding, min_relevance=25, page=1, results_per_page=25, filters=None, filter_only=False, user=None):
    logger.info("Buscando correos para intent: %s, term_groups: %s, min_relevance: %s, page: %s, filters: %s, filter_only: %s, user: %s",
                intent, term_groups, min_relevance, page, filters, filter_only, user.username if user else 'None')
